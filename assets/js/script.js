$(function () {
  ...
  // Get social worker under a category
  $(document).on("change", "#service-category", function(value){
      if(this.value == "all"){
        window.location.replace("all-workers.php");
      } else{
        window.location.replace("all-workers.php?category_id="+this.value);
      }
   });
